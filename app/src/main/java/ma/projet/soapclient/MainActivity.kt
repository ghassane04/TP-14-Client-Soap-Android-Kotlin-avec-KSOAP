    ...
    */
    private fun setupRecyclerView() {
        ...
        adapter.onEditClick = { compte ->
             Toast.makeText(this, "Modification non implémentée dans ce TP", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    */
    private fun showAddCompteDialog() {
        ...
        .setPositiveButton("Ajouter") { _, _ ->
            ...
            val soldeText = etSolde.text.toString()
            if (soldeText.isBlank()) {
                Toast.makeText(this, "Veuillez entrer un solde", Toast.LENGTH_SHORT).show()
                return@setPositiveButton
            }

            val solde = soldeText.toDoubleOrNull() ?: 0.0
